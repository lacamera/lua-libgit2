...
/* Callable function name : luagit2_signature_default(lua_userdata
 * luagit2_repository )
 *
...
/* Callable function name : luagit2_signature_from_buffer(lua_string
 * buffer_string )
 *
...
/* Callable function name : luagit2_signature_now(lua_string name,lua_string
 email )
 *
...
/* Callable function name : luagit2_signature_free(lua_userdata
 * luagit2_signature )
 *
