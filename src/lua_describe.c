...
int lua_git_describe_commit(lua_State *L) {
  ...
  luagit2_describe_result *lua_describe_res =
      (luagit2_describe_result *)lua_newuserdata(L, sizeof(*lua_describe_res));
  ...
  check_error_long(
      git_describe_commit(&local_describe_result, lua_object->object,
                          NULL),  // passing NULL for default values
...
int lua_git_describe_workdir(lua_State *L) {
  ...
  git_describe_result *local_describe_result;
  check_error_long(
      git_describe_workdir(&local_describe_result, Repo->repo,
                           NULL),  // passing NULL for default values
...
int lua_git_describe_format(lua_State *L) {
  ...
  const luagit2_describe_result *lua_describe_res =
      (luagit2_describe_result *)luaL_checkudata(L, 1,
  ...
  check_error_long(
      git_describe_format(&local_buf, lua_describe_res->describe_result, NULL),
