...
/* Callable function name : luagit2_tree_entry_byid(lua_userdata luagit2_tree,
 lua_userdata luagit2_oid )
 *
...
/* Callable function name : luagit2_tree_entry_byindex(lua_userdata
 luagit2_tree, lua_integer index )
 *
...
/* Callable function name : luagit2_tree_entry_byname(lua_userdata luagit2_tree,
 lua_string filename )
 *
...
/* Callable function name : luagit2_tree_entry_bypath(lua_userdata luagit2_tree,
 lua_string path )
 *
...
/* Callable function name : luagit2_tree_tree_entry_cmp(lua_userdata
 luagit2_tree_entry, lua_userdata luagit2_tree_entry )
 *
 * Compare two tree entries.
 *
 * Params required : (lua_userdata) 1st tree entry,
                     (lua_userdata) 2nd tree entry.
 * Returns : integer value , < 0 if entry1 is before entry2, 0 if entry1 ==
 entry2, >0 if entry1 is after entry2 .
 */
int lua_git_tree_entry_cmp(lua_State *L);

/* Callable function name : luagit2_tree_tree_entry_filemode(lua_userdata
 * luagit2_tree_entry )
 *
...
/* Callable function name : luagit2_tree_tree_entry_filemode_raw(lua_userdata
 * luagit2_tree_entry )
 *
 * Params required : (lua_userdata) tree entry,
...
/* Callable function name : luagit2_tree_tree_entry_id(lua_userdata
 * luagit2_tree_entry )
 *
 * Params required : (lua_userdata) tree entry,
...
/* Callable function name : luagit2_tree_tree_entry_name(lua_userdata
 * luagit2_tree_entry )
 *
 * Params required : (lua_userdata) tree entry,
...
/* Callable function name : luagit2_tree_tree_entry_to_object(lua_userdata
 * luagit2_tree_entry )
 *
...
/* Callable function name : luagit2_tree_tree_entry_type(lua_userdata
 * luagit2_tree_entry )
 *
...
/* Callable function name : luagit2_tree_tree_entrycount(lua_userdata
 * luagit2_tree)
 *
...
/* Callable function name : luagit2_tree_tree_entrycount(lua_userdata
 luagit2_repository, lua_userdata luagit2_oid)
 *
...
/* Callable function name : luagit2_tree_tree_entrycount(lua_userdata
 luagit2_repository, lua_userdata luagit2_oid , lua_integer length)
 *
...
/* Callable function name : luagit2_tree_entry_free(lua_userdata
 * luagit2_tree_entry)
 *
