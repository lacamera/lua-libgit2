...
/* Callable function name : luagit2_get_signature_details(lua_userdata
 luagit2_signature, lua_integer option_number)
 *
 ...
 * luagit2_print_complete_signature_details(lua_userdata luagit2_signature)
 *
