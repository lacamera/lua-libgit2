...
int lua_git_repository_open_from_worktree(lua_State *L) {
  ...
  luagit2_repository *lua_repo;
  luagit2_worktree *lua_worktree =
      (luagit2_worktree *)luaL_checkudata(L, 1, "luagit2_worktree");
...
int lua_git_repository_set_head(lua_State *L) {
  if (lua_gettop(L) != 2) {
    return luaL_error(L,
                      "expecting 2 argument(s) : luagit2_repository,refname");
  }
...
int lua_git_repository_set_ident(lua_State *L) {
  if (lua_gettop(L) != 3) {
    return luaL_error(
        L, "expecting 3 argument(s) : luagit2_repository,name,email");
  }
...
int lua_git_repository_set_namespace(lua_State *L) {
  if (lua_gettop(L) != 2) {
    return luaL_error(
        L, "expecting 2 argument(s) : luagit2_repository,name_space");
  }
...
int lua_git_repository_set_workdir(lua_State *L) {
  if (lua_gettop(L) != 3) {
    return luaL_error(L,
                      ...
                      "luagit2_repository,workdir,update_gitlink(int)");
  }
...
int lua_git_repository_set_index(lua_State *L) {
  if (lua_gettop(L) != 2) {
    return luaL_error(
        L, "expecting 2 argument(s) : luagit2_repository,luagit2_index");
  }
...
int lua_git_repository_set_config(lua_State *L) {
  if (lua_gettop(L) != 2) {
    return luaL_error(
        L, "expecting 2 argument(s) : luagit2_repository,luagit2_config");
  }

  const luagit2_repository *lua_repo =
      (luagit2_repository *)luaL_checkudata(L, 1, "luagit2_repository");
  const luagit2_config *lua_cfg =
      (luagit2_config *)luaL_checkudata(L, 2, "luagit2_config");
...
int lua_git_repository_set_odb(lua_State *L) {
  if (lua_gettop(L) != 2) {
    return luaL_error(
        L, "expecting 2 argument(s) : luagit2_repository,luagit2_odb");
  }

  const luagit2_repository *lua_repo =
      (luagit2_repository *)luaL_checkudata(L, 1, "luagit2_repository");
  const luagit2_odb *lua_odb =
      (luagit2_odb *)luaL_checkudata(L, 2, "luagit2_odb");
