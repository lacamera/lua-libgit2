...
/* Callable function name : luagit2_oid_fromstrn(lua_string hex_string,
 lua_integer length)
 *
...
/* Callable function name : luagit2_oid_cmp(lua_userdata luagit2_oid,
 ...
 * Returns : integer value as : < 0 if oid_1 < oid_2, 0 ifoid_1 == oid_2, >0 if
 oid_1 > oid_2.
 */
int lua_git_oid_cmp(lua_State *L);

/* Callable function name : luagit2_oid_cmp(lua_userdata luagit2_oid,
 lua_userdata luagit2_oid, lua_integer length)
 *
