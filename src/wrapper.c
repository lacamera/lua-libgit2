...
static const struct luaL_Reg luagit2[] = {
    ...
    {"enable_strict_object_creation",
     lua_GIT_OPT_ENABLE_STRICT_OBJECT_CREATION},
    {"enable_strict_symbolic_ref_creation",
     lua_GIT_OPT_ENABLE_STRICT_SYMBOLIC_REF_CREATION},
    ...
    {"enable_strict_hash_verification",
     lua_GIT_OPT_ENABLE_STRICT_HASH_VERIFICATION},
    ...
    {"repository_submodule_cache_clear",
     lua_git_repository_submodule_cache_clear},
    ...
    {"reference_symbolic_create_matching",
     lua_git_reference_symbolic_create_matching},
    ...
    {"annotated_commit_from_fetchhead",
     lua_git_annotated_commit_from_fetchhead},
    ...
    {"diff_tree_to_workdir_with_index",
     lua_git_diff_tree_to_workdir_with_index},
    ...
    {"cred_ssh_key_from_agent_details",
     lua_git_cred_ssh_key_from_agent_details},
