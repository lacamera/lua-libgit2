...
int lua_git_index_add(lua_State *L) {
  if (lua_gettop(L) != 2) {
    return luaL_error(
        L,
        "expecting exactly 2 arguments : luagit2_index, luagit2_index_entry");
  }

  luagit2_index *Index =
      (luagit2_index *)luaL_checkudata(L, 1, "luagit2_index");
  const luagit2_index_entry *Index_entry =
      (luagit2_index_entry *)luaL_checkudata(L, 2, "luagit2_index_entry");
...
int lua_git_index_add_bypath(lua_State *L) {
  if (lua_gettop(L) != 2) {
    return luaL_error(
        L, "expecting exactly 2 arguments : luagit2_index, (string)path");
  }
  ...
  check_error_long(git_index_add_bypath(Index->index, path),
                   "Unable to add/update from file pointed by given path",
                   NULL);
...
int lua_git_index_conflict_add(lua_State *L) {
  if (lua_gettop(L) != 4) {
    return luaL_error(
        L,
        "expecting exactly 1 argument : luagit2_index,(luagit2_index_entry)ancestor,\
			(luagit2_index_entry)ours,(luagit2_index_entry)theirs");
  }

  luagit2_index *Index =
      (luagit2_index *)luaL_checkudata(L, 1, "luagit2_index");
  const luagit2_index_entry *Index_ancestor_entry =
      (luagit2_index_entry *)luaL_checkudata(L, 2, "luagit2_index_entry");
  const luagit2_index_entry *Index_our_entry =
      (luagit2_index_entry *)luaL_checkudata(L, 3, "luagit2_index_entry");
  const luagit2_index_entry *Index_their_entry =
      (luagit2_index_entry *)luaL_checkudata(L, 4, "luagit2_index_entry");

  check_error_long(
      git_index_conflict_add(Index->index, Index_ancestor_entry->index_entry,
                             Index_our_entry->index_entry,
                             Index_their_entry->index_entry),
...
int lua_git_index_entry_is_conflict(lua_State *L) {
  ...
  luagit2_index_entry *Index_entry =
      (luagit2_index_entry *)luaL_checkudata(L, 1, "luagit2_index_entry");
...
int lua_git_index_find_prefix(lua_State *L) {
  if (lua_gettop(L) != 2) {
    return luaL_error(
        L, "expecting exactly 2 arguments : luagit2_index,(string)prefix");
  }
...
int lua_git_index_get_byindex(lua_State *L) {
  if (lua_gettop(L) != 2) {
    return luaL_error(
        L,
        "expecting exactly 2 arguments : luagit2_index,(integer)index_value");
  }
...
int lua_git_index_get_bypath(lua_State *L) {
  if (lua_gettop(L) != 3) {
    return luaL_error(L,
                      ...
                      "luagit2_index,(string)path,(integer)stage_value");
  }
...
int lua_git_index_open(lua_State *L) {
  if (lua_gettop(L) != 1) {
    return luaL_error(L,
                      "expecting exactly 1 argument : (string)index_file_path");
  }
  ...
  check_error_long(
      ...
      "Unable to create git object of index type from file at given path",
      NULL);
...
int lua_git_index_read(lua_State *L) {
  if (lua_gettop(L) != 2) {
    return luaL_error(
        L, "expecting exactly 2 argument : luagit2_index,(integer)force");
  }
...
int lua_git_index_read_tree(lua_State *L) {
  if (lua_gettop(L) != 2) {
    return luaL_error(
        L, "expecting exactly 2 arguments : luagit2_index,luagit2_tree");
  }
...
int lua_git_index_remove_bypath(lua_State *L) {
  ...
  check_error_long(git_index_remove_bypath(Index->index, path),
                   "Unable to remove entry from index that corresponds to file "
                   "path provided",
                   NULL);
...
int lua_git_index_remove_directory(lua_State *L) {
  ...
  check_error_long(git_index_remove_directory(Index->index, dir_path, stage),
                   "Unable to remove all entries at given directory path",
                   NULL);
...
int lua_git_index_set_caps(lua_State *L) {
  if (lua_gettop(L) != 2) {
    return luaL_error(
        L, "expecting exactly 2 arguments : luagit2_index,(integer)caps");
  }
...
int lua_git_index_set_version(lua_State *L) {
  if (lua_gettop(L) != 2) {
    return luaL_error(
        L, "expecting exactly 2 arguments : luagit2_index,(integer)version");
  }
...
int lua_git_index_write_tree_to(lua_State *L) {
  ...
  const luagit2_repository *Repo =
      (luagit2_repository *)luaL_checkudata(L, 2, "luagit2_repository");
